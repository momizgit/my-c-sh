...
namespace Simple_Agent_GUI_RunCommand
{
    class RunCommand
    {
        public bool IsInitialized;
        private static string varProcessOutput { get; set; }
        private static string varCommandExecutable { get; set; }
        private static string varProcessCommandName { get; set; }
        private static string ErrorOutString { get; set; }
        private static Thread RunCommadThread{ get; set; }

        public RunCommand(String ProcessCommandName = "", String ProcessCommandArg="")
        {
            IsInitialized = true;
        }
        ...
        public void run()
        {
            RunCommadThread = new Thread(new ThreadStart(() => 
            {
                try
                {
                    ...
                    varProcessOutput = process.StandardOutput.ReadToEnd();
                    process.WaitForExit();
                }
                catch (Exception e)
                {
